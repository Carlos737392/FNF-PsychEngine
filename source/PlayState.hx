...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'stage': //Week 1
				var bg:BGSprite = new BGSprite('stageback', 150, 400, 0.9, 0.9);
			...
			case 'spooky': //Week 2
				if(!ClientPrefs.lowQuality) {
					halloweenBG = new BGSprite('halloween_bg', 350, 300, ['halloweem bg0', 'halloweem bg lightning strike']);
					halloweenBG.scale.set(4.0, 4.0);
				} else {
					halloweenBG = new BGSprite('halloween_bg_low', 350, 300);
					halloweenBG.scale.set(4.0, 4.0);
				}
				add(halloweenBG);
